<?php
   ...
   if(!isset($_SESSION['user_data'])){
      header("location: http://localhost/blogWeb/login.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
   <head>
      ...
      <title>MyDailyBlog</title>
      <!-- Custom fonts for this template-->
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" rel="stylesheet" type="text/css">
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/fontawesome.min.css" rel="stylesheet" type="text/css">
      ...
      <div id="wrapper">
         ...
         <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
               ...
               <div class="sidebar-brand-text mx-3">MyDailyBlog</div>
            </a>
            <!-- Divider -->
               ...
               <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                  ...
                  <?php
                     ...
                     if (isset($_SESSION['msg'])) {
                        ...
                        $massage =  $_SESSION['msg']['0'];
                        $bs_class =  $_SESSION['msg']['1'];
                        ?>
                        <div class="mt-3 alert alert-dismissible <?php echo $bs_class ?>">
                           <?php echo $massage ?>
